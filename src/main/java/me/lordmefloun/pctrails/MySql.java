    ...
    public void mysqlSetup() {
        ...
        try{
            synchronized (this){
                ...
                Bukkit.getConsoleSender().sendMessage(ChatColor.GOLD + "[PcTrails] MySQL connection successfull");
            }
        ...
        try (PreparedStatement statement = this.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS `"+ database +"`.`" + table + "` ( `id` INT(225) NOT NULL AUTO_INCREMENT , `player` VARCHAR(225) NOT NULL , `trail` INT(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");){
